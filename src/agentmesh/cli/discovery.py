"""Framework & dependency detection for `agentmesh scan`.
...
class FrameworkInfo:
    ...
    name: str                # "crewai", "langgraph", "autogen", "langchain", "llamaindex", "pydantic_ai"
...
_CONFIG_FILES = (
    ...
    "crewai.yaml", ".agentmesh.yaml", "mcp.json",
)
